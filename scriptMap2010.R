...
png("~/Documents/adelaide_wine_map/Cabernet_Sauvignon_2010.png", width=900,height=550)
cepMapping<-ggplot()+
  ...
  labs(fill = "Intervales \n kmeans \n en % de surface \n mondiale", 
        title="Proportion de Cabernet Sauvignons par pays \n 
              par rapport aux surfaces mondiales (2010)")
  coord_equal()
print(cepMapping)
dev.off()

png("~/Documents/adelaide_wine_map/Cabernet_Franc_2010.png", width=900,height=550)
cepMapping<-ggplot()+
  ...
  labs(fill = "Intervales \n kmeans \n en % de surface \n mondiale", 
        title="Proportion de Cabernet Franc par pays \n 
              par rapport aux surfaces mondiales (2010)")
  coord_equal()
print(cepMapping)
dev.off()
...
png("~/Documents/adelaide_wine_map/wine_in_world_2010.png", width=900,height=550)
cepMappingW<-ggplot()+
  ...
  labs(fill = "Intervales \n kmeans \n en % de surface \n mondiale",
       title="Proportion des surfaces viticoles mondiale \n par pays (2010)")
  coord_equal()
print(cepMappingW)
dev.off()
...
for (i in 1:length(data2000[1,])){
  ...
  if(nb_viti_country > 10 & !is.na(nb_viti_country)){
    ...
    if (max(as.numeric(as.character(space$class)))>3){
      ...
      #carto avec GGplot2
      png(paste("~/Documents/adelaide_wine_map/map2010/",nameIndex[i],"_k.png",sep=""), width=900,height=550)
      cepMapping<-ggplot()+
